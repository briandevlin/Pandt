...
public class ImageHolder {
    ...
    public static void applyMultiIconTo(Drawable icon,  ImageView imageView) {
        //if we have an imageHolder then we want to set it
        if (icon != null) {
            imageView.setImageDrawable(icon);
            //make sure we display the imageHolder
            imageView.setVisibility(View.VISIBLE);
        } else {
            //hide the imageHolder
    ...
    public static void applyMultiIconTo(Drawable icon, int iconColor, Drawable selectedIcon, int selectedIconColor, boolean tinted, ImageView imageView) {
        ...
        if (icon != null) {
            ...
            if (selectedIcon != null) {
                imageView.setImageDrawable(Utils.getIconStateList(icon, selectedIcon));
            } else if (tinted) {
