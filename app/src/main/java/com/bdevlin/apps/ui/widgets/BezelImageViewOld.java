 ...
 */
public class BezelImageViewOld extends ImageView {
    ...
    public BezelImageViewOld(Context context) {
        this(context, null);
    }

    public BezelImageViewOld(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BezelImageViewOld(Context context, AttributeSet attrs, int defStyle) {
