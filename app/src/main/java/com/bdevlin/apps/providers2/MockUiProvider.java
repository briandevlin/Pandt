...
//import com.bdevlin.apps.provider2.ConversationInfo;
...
import  com.bdevlin.apps.providers2.UIProvider.AttachmentColumns;
import  com.bdevlin.apps.providers2.UIProvider.ConversationColumns;
import  com.bdevlin.apps.providers2.UIProvider.FolderCapabilities;
import  com.bdevlin.apps.providers2.UIProvider.FolderColumns;
import  com.bdevlin.apps.providers2.UIProvider.MessageColumns;
...
public final class MockUiProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.bdevlin.apps.pandt.MockUiProvider";
    ...
    private static void initializeAccount(int accountId,
        ...
        resultMap.put(inboxfolderDetailsMap.get(FolderColumns.URI).toString(), ImmutableList.of(inboxfolderDetailsMap));

        final Map<String, Object> accountDetailsMap = createAccountDetailsMap(accountId, (String)inboxfolderDetailsMap.get(FolderColumns.URI));
				
        resultMap.put(((Uri) accountDetailsMap.get(AccountColumns.URI)).toString(), ImmutableList.of(accountDetailsMap));
