...
//            .put(AccountColumns.SettingsColumns.MOVE_TO_INBOX, String.class)
    ...
    public static final class AccountColumns implements BaseColumns {
         ...
         * in {@link com.bdevlin.apps.provider2.UIProvider.SearchQueryParameters}
         * The cursor returned from this query is expected have one row, where the columnm are a
         * subset of the columns specified in {@link com.bdevlin.apps.provider2.UIProvider.FolderColumns}
         */
         ...
         * shown.
         * Optionally, extra values from {@link com.bdevlin.apps.provider2.UIProvider.EditSettingsExtras} can be used to indicate
         ...
         * {@link com.bdevlin.apps.provider2.UIProvider.ConversationColumns#CONVERSATION_BASE_URI} column. The cursor returned from this
         * query is expected have one row, where the columns are specified in
         * {@link com.bdevlin.apps.provider2.UIProvider.AccountCookieColumns}
         */
        public static final String ACCOUNT_COOKIE_QUERY_URI = "accountCookieUri";
        /**
         * URI to be used with an update() ContentResolver call with a {@link android.content.ContentValues} object
         * where the keys are from the {@link com.bdevlin.apps.provider2.UIProvider.AccountColumns.SettingsColumns}, and the values are
         * the new values.
         */
        ...
        public static final class SettingsColumns {
             ...
             * be one of the values in {@link com.bdevlin.apps.provider2.UIProvider.AutoAdvance}
             */
             ...
             * value will be one of the values in {@link com.bdevlin.apps.provider2.UIProvider.MessageTextSize}
             */
             ...
             * will be one of the values in {@link com.bdevlin.apps.provider2.UIProvider.SnapHeaderValue}
             */
             ...
             * will be one of the values in {@link com.bdevlin.apps.provider2.UIProvider.DefaultReplyBehavior}
             */
             ...
             * {@link com.bdevlin.apps.provider2.UIProvider.ConversationListIcon}.
             */
            ...
            /**
             * Integer column containing a value matching one of the constants from {@link com.bdevlin.apps.provider2.UIProvider.Swipe}
             */
             ...
             * constants from  {@link com.bdevlin.apps.provider2.UIProvider.ConversationViewMode}
             */
     ...
     * {@link com.bdevlin.apps.provider2.UIProvider#CONVERSATION_PROJECTION} projection will fit in a single
    ...
    public static final class ConversationColumns {
         ...
         * values with keys listed in {@link com.bdevlin.apps.provider2.UIProvider.CursorExtraKeys}
         */
         ...
         * {@link com.bdevlin.apps.provider2.UIProvider.ConversationCursorCommand#COMMAND_GET_CONVERSATION_INFO} instead.
         */
        @Deprecated
         ...
         *
         * @deprecated providers should implement
         * {@link com.bdevlin.apps.provider2.UIProvider.ConversationCursorCommand#COMMAND_GET_RAW_FOLDERS} instead.
         */
        @Deprecated
         ...
         * {@link com.bdevlin.apps.provider2.UIProvider.ConversationPersonalLevel}.
         */
    ...
    public static final class ConversationCursorCommand {
        ...
        /**
         * Clients must set this bit when the {@link android.database.Cursor#respond(android.os.Bundle)} call is being used to
         * fetch a {@link android.os.Parcelable}. It serves as a hint that this call requires the cursor
         ...
         * should just use {@link android.os.Bundle#containsKey(String)} to check for this kind of request and
     ...
     * with {@link android.content.ContentProvider#update(android.net.Uri, android.content.ContentValues, String, String[])}
     ...
     * the {@link com.bdevlin.apps.provider2.UIProvider.ConversationOperations#OPERATION_KEY}
     * <p/>
     * Note not all UI providers will support these operations.  {@link com.bdevlin.apps.provider2.UIProvider.AccountCapabilities} can
     ...
     * {@link android.content.ContentResolver#call(android.net.Uri,String,String, android.os.Bundle)}
    ...
    public static final class AccountCallMethods {
         ...
         * {@link android.content.ContentResolver#call(android.net.Uri,String,String, android.os.Bundle)} should have the
         * columns specified in {@link com.bdevlin.apps.provider2.UIProvider.MessageColumns}, and if this is a save for an existing
         * message, an entry for the {@link com.bdevlin.apps.provider2.UIProvider.MessageColumns#URI} should reference the existing
         * message
         *
         * The Bundle returned will contain the message uri in the returned bundled with the
         * {@link com.bdevlin.apps.provider2.UIProvider.MessageColumns#URI} key.
         */
         ...
         * {@link android.content.ContentResolver#call(android.net.Uri,String,String, android.os.Bundle)} should have the
         * columns specified in {@link com.bdevlin.apps.provider2.UIProvider.MessageColumns}, and if this is a send of an existing
         * message, an entry for the {@link com.bdevlin.apps.provider2.UIProvider.MessageColumns#URI} should reference the existing
         * message
         *
         * The Bundle returned will contain the message uri in the returned bundled with the
         ...
         * {@link android.content.ContentResolver#call(android.net.Uri,String,String, android.os.Bundle)} should have the
         * columns specified in {@link com.bdevlin.apps.provider2.UIProvider.SetCurrentAccountColumns}
         *
    ...
    /**
     * Keys used for parameters to {@link com.bdevlin.apps.provider2.UIProvider.AccountCallMethods#SEND_MESSAGE} or
     * {@link com.bdevlin.apps.provider2.UIProvider.AccountCallMethods#SAVE_MESSAGE} methods.
     */
    ...
    public static final class CursorExtraKeys {
         ...
         * one defined in {@link com.bdevlin.apps.provider2.UIProvider.CursorStatus}.
         */
    ...
    public static final class MessageColumns {
         ...
         * draft. See {@link com.bdevlin.apps.provider2.UIProvider.DraftType} for possible values.
         */
         ...
         * can be retrieved using the URI in {@link com.bdevlin.apps.provider2.UIProvider.MessageColumns#ATTACHMENT_LIST_URI}.
         */
        public static final String HAS_ATTACHMENTS = "hasAttachments";
        /**
        ...
        /**
         * This long column is a bit field of flags defined in {@link com.bdevlin.apps.provider2.UIProvider.MessageFlags}.
         */
         ...
         * See {@link com.bdevlin.apps.provider2.UIProvider.SpamWarningLevel} for possible values.
         */
         ...
         * See {@link com.bdevlin.apps.provider2.UIProvider.SpamWarningLinkType} for possible values.
         */
    ...
    /**
     * Valid states for the {@link com.bdevlin.apps.provider2.UIProvider.AttachmentColumns#STATE} column.
     *
     */
    public static final class AttachmentState {
         ...
         * {@link com.bdevlin.apps.provider2.UIProvider.AttachmentColumns#DOWNLOADED_SIZE} should reflect the current
         ...
         * the accompanying destination in {@link com.bdevlin.apps.provider2.UIProvider.AttachmentColumns#DESTINATION}
         * .
         * <p>
         ...
         * {@link com.bdevlin.apps.provider2.UIProvider.AttachmentColumns#DESTINATION}. If a provider later detects
         ...
         * {@link com.bdevlin.apps.provider2.UIProvider.AttachmentColumns#DESTINATION}.
         * <p>
    ...
    public static final class AttachmentColumns {
         ...
         * attachment as defined in {@link com.bdevlin.apps.provider2.UIProvider.AttachmentState}.
         * <p>
         ...
         * {@link com.bdevlin.apps.provider2.UIProvider.AttachmentState#DOWNLOADING}) or the resulting downloaded file
         * ( when {@link #STATE} is {@link com.bdevlin.apps.provider2.UIProvider.AttachmentState#SAVED}), as defined
         * in {@link com.bdevlin.apps.provider2.UIProvider.AttachmentDestination}. This value is undefined in any
         * other state.
         * <p>
         * Providers must accept updates to {@link #URI} with new values of
         ...
         * {@link #STATE} is {@link com.bdevlin.apps.provider2.UIProvider.AttachmentState#DOWNLOADING}. This value is
         ...
         * {@link com.bdevlin.apps.provider2.UIProvider.AttachmentState#SAVED}. This value is undefined in any other
         * state.
         */
         ...
         * {@link com.bdevlin.apps.provider2.UIProvider.AttachmentType} constants.
         */
        public static final String TYPE = "type";
     ...
     * {@link com.bdevlin.apps.provider2.UIProvider.ConversationOperations#OPERATION_KEY}.
     */
     ...
     * {@link com.bdevlin.apps.provider2.UIProvider.UpdateNotificationExtras#EXTRA_FOLDER} {@link com.bdevlin.apps.provider2.UIProvider.UpdateNotificationExtras#EXTRA_ACCOUNT}
     */
