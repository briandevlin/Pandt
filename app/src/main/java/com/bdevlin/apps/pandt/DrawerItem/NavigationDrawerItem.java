    ...
    //    }
        ...
        public NavigationDrawerItem(ControllableActivity activity, Cursor c) {
            ...
            if (c != null) {
                baseId = c.getInt(PandTContract.Folders.FOLDER_ID_COLUMN);
                baseName = new StringHolder(c.getString(PandTContract.Folders.FOLDER_NAME_COLUMN));
                baseIcon = c.getString(PandTContract.Folders.FOLDER_ICON_COLUMN);
                baseUri = c.getString(PandTContract.Folders.FOLDER_URI_COLUMN);
